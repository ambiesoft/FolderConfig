...
namespace Ambiesoft { namespace FolderConfig {
	void Form1::InitializeComponent(void)
	{
		...
		this->lblLiteralOKMessage = (gcnew System::Windows::Forms::Label());
		...
		this->radioUnderThis->CheckedChanged += gcnew System::EventHandler(this, &Form1::radio_CheckedChanged);
		// 
		// radioLocal
		// 
		...
		this->radioLocal->CheckedChanged += gcnew System::EventHandler(this, &Form1::radio_CheckedChanged);
		// 
		// radioUserDefine
		// 
		...
		this->radioUserDefine->CheckedChanged += gcnew System::EventHandler(this, &Form1::radio_CheckedChanged);
		// 
		// radioRoaming
		// 
		...
		this->radioRoaming->CheckedChanged += gcnew System::EventHandler(this, &Form1::radio_CheckedChanged);
		// 
		// label2
		// 
		...
		this->groupBox1->Controls->Add(this->lblLiteralOKMessage);
		...
		// lblLiteralOKMessage
		// 
		this->lblLiteralOKMessage->AccessibleDescription = nullptr;
		this->lblLiteralOKMessage->AccessibleName = nullptr;
		resources->ApplyResources(this->lblLiteralOKMessage, L"lblLiteralOKMessage");
		this->lblLiteralOKMessage->Font = nullptr;
		this->lblLiteralOKMessage->Name = L"lblLiteralOKMessage";
		// 
		// btnBrowse
		// 
		...
		this->btnReverToDefault->Click += gcnew System::EventHandler(this, &Form1::btnReverToDefault_Click);
		// 
		// Form1
		// 
